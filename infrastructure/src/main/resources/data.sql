...
VALUES (PARKING_LOT_SEQUENCE.NEXTVAL, 'Parking One', 'ABOVE_GROUND', 'Street One', '99', '3000', 'Leuven', 50, 25, 2);
INSERT INTO PARKING_LOT(ID, PARKING_NAME, PARKING_CATEGORY, STREET_NAME, STREET_NUMBER, POST_CODE, POST_LABEL, PARKING_MAX_SIZE, ALLOCATION_PRICE_PER_HOUR, CONTACT_PERSON_ID)
VALUES (PARKING_LOT_SEQUENCE.NEXTVAL, 'Parking Two', 'UNDERGROUND', 'Street Two', '25', '1000', 'Brussels', 25, 10, 1);